/datum/advclass/formerfatguy
	name = "Former Fat Guy"
	tutorial = "Instead of beating you, your family overfed and tried to sell your Pudge to a witch, you ran away, and lost the fat along the path. +5 Endurance -3 Intelligence"
	...
	outfit = /datum/outfit/job/roguetown/adventurer/formerfatguy
	category_tags = list(CTAG_PILGRIM, CTAG_TOWNER)

/datum/outfit/job/roguetown/adventurer/formerfatguy/pre_equip(mob/living/carbon/human/H)
	..()
